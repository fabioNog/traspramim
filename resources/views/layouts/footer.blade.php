      ...
      <div class="container inner">
        <div class="row">
          <div class="col-md-4 col-lg-3">
            <div class="widget">
              <img src="{{url('/')}}" srcset="style/images/logo/logo.png 1x, style/images/logo/logo.png 2x" alt="" />
              <div class="space40"></div>
              <p>© 2021 Trás Pra Mim. <br class="d-none d-lg-block" />All rights reserved.</p>
            </div>
            <!-- /.widget -->
          </div>
          <!-- /column -->
