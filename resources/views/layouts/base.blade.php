    ...
    <div class="content-wrapper">
                        ...
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#!">Pages</a>
                            <ul class="dropdown-menu">
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle" href="#">Services</a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a class="dropdown-item" href="{{ asset('services.html')}}">Services I</a></li>
                                        <li class="nav-item"><a class="dropdown-item" href="{{ asset('services2.html')}}">Services II</a></li>
                                        <li class="nav-item"><a class="dropdown-item" href="{{ asset('services3.html')}}">Services III</a></li>
                                        <li class="nav-item"><a class="dropdown-item" href="{{ asset('services4.html')}}">Services IV</a></li>
                                        <li class="nav-item"><a class="dropdown-item" href="{{ asset('services5.html')}}">Services V</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle" href="#">Shop</a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a class="dropdown-item" href="{{ asset('shop.html')}}">Shop</a></li>
                                        <li class="nav-item"><a class="dropdown-item" href="{{ asset('shop2.html')}}">Shop with Sidebar</a></li>
                                        <li class="nav-item"><a class="dropdown-item" href="{{ asset('shop3.html')}}">Shop with Left Sidebar</a></li>
                                        <li class="nav-item"><a class="dropdown-item" href="{{ asset('shop-product.html')}}">Product Page</a></li>
                                        <li class="nav-item"><a class="dropdown-item" href="{{ asset('shop-cart.html')}}">Shopping Cart</a></li>
                                        <li class="nav-item"><a class="dropdown-item" href="{{ asset('shop-checkout.html')}}">Checkout</a></li>
                                    </ul>
                                </li>
                                ...
                                <li><a class="dropdown-item" href="{{ asset('scroll-animation.html')}}">Scroll Animation</a></li>
                            </ul>
                        </li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <ul class="list-unstyled">
                                                ...
                                                <li><a href="{{ asset('social-icons.html')}}">Social Icons</a></li>
        ...
        <div class="wrapper light-wrapper page-title-wrapper">
            <div class="container inner text-center">
                <h1 class="page-title">Box Portfolio with Item Details</h1>
                ...
                <div class="grid grid-view boxed">
                    <div class="isotope-filter text-center">
                        <ul>
                            ...
                            <li><a class="button" data-filter=".branding">Branding</a></li>
                            <li><a class="button" data-filter=".corporate">Corporate</a></li>
                            <li><a class="button" data-filter=".application">Application</a></li>
                    ...
                    <div class="tiles">
                        <div class="row isotope light-gallery-wrapper">
                            <div class="item item-detailed grid-sizer col-md-6 col-lg-4 application">
                                <div class="box bg-white shadow p-30">
                                    <figure class="main rounded mb-30">
                                        <div class="item-detailed-image"><img src="{{ asset('style/images/art/s1.jpg')}}" alt="" /><img src="{{ asset('style/images/art/s1-2.jpg')}}" alt="" /></div>
                                        <a href="{{ asset('style/images/art/s1.jpg')}}" class="hover-icon-first lightbox" data-tip="Enlarge image"><i class="jam jam-qr-code"></i></a>
                            ...
                            <!-- /.item -->
                            <div class="item item-detailed grid-sizer col-md-6 col-lg-4 corporate branding">
                                <div class="box bg-white shadow p-30">
                                    <figure class="main rounded mb-30">
                                        <div class="item-detailed-image"><img src="{{ asset('style/images/art/s2.jpg')}}" alt="" /><img src="{{ asset('style/images/art/s2-2.jpg')}}" alt="" /></div>
                                        <a href="{{ asset('style/images/art/s2.jpg')}}" class="hover-icon-first lightbox" data-tip="Enlarge image"><i class="jam jam-qr-code"></i></a>
                                        <a href="#" class="hover-icon-second" data-tip="See details"><i class="jam jam-link"></i></a>
                                    </figure>
                                    <div class="item-content">
                            ...
                            <div class="item item-detailed grid-sizer col-md-6 col-lg-4 application">
                                <div class="box bg-white shadow p-30">
                                    <figure class="main rounded mb-30">
                                        <div class="item-detailed-image"><img src="{{ asset('style/images/art/s3.jpg')}}" alt="" /><img src="{{ asset('style/images/art/s3-2.jpg')}}" alt="" /></div>
                                        <a href="{{ asset('style/images/art/s3.jpg')}}" class="hover-icon-first lightbox" data-tip="Enlarge image"><i class="jam jam-qr-code"></i></a>
                                        <a href="#" class="hover-icon-second" data-tip="See details"><i class="jam jam-link"></i></a>
                                    </figure>
                                    <div class="item-content">
                            ...
                            <!-- /.item -->
                            <div class="item item-detailed grid-sizer col-md-6 col-lg-4 video application">
                                <div class="box bg-white shadow p-30">
                                    <figure class="main rounded mb-30">
                                        <div class="item-detailed-image"><img src="{{ asset('style/images/art/s4.jpg')}}" alt="" /><img src="{{ asset('style/images/art/s4-2.jpg')}}" alt="" /></div>
                                        <a href="{{ asset('style/images/art/s4.jpg')}}" class="hover-icon-first lightbox" data-tip="Enlarge image"><i class="jam jam-qr-code"></i></a>
                                        <a href="#" class="hover-icon-second" data-tip="See details"><i class="jam jam-link"></i></a>
                                    </figure>
                                    <div class="item-content">
                            ...
                            <!-- /.item -->
                            <div class="item item-detailed grid-sizer col-md-6 col-lg-4 branding">
                                <div class="box bg-white shadow p-30">
                                    <figure class="main rounded mb-30">
                                        <div class="item-detailed-image"><img src="{{ asset('style/images/art/s5.jpg')}}" alt="" /><img src="{{ asset('style/images/art/s5-2.jpg')}}" alt="" /></div>
                                        <a href="{{ asset('style/images/art/s5.jpg')}}" class="hover-icon-first lightbox" data-tip="Enlarge image"><i class="jam jam-qr-code"></i></a>
                                        <a href="#" class="hover-icon-second" data-tip="See details"><i class="jam jam-link"></i></a>
                                    </figure>
                                    <div class="item-content">
                            ...
                            <div class="item item-detailed grid-sizer col-md-6 col-lg-4 corporate branding">
                                <div class="box bg-white shadow p-30">
                                    <figure class="main rounded mb-30">
                                        <div class="item-detailed-image"><img src="{{ asset('style/images/art/s6.jpg')}}" alt="" /><img src="{{ asset('style/images/art/s6-2.jpg')}}" alt="" /></div>
                                        <a href="{{ asset('style/images/art/s6.jpg')}}" class="hover-icon-first lightbox" data-tip="Enlarge image"><i class="jam jam-qr-code"></i></a>
                                        <a href="#" class="hover-icon-second" data-tip="See details"><i class="jam jam-link"></i></a>
                                    </figure>
                                    <div class="item-content">
                            ...
                            <!-- /.item -->
                            <div class="item item-detailed grid-sizer col-md-6 col-lg-4 video">
                                <div class="box bg-white shadow p-30">
                                    <figure class="main rounded mb-30">
                                        <div class="item-detailed-image"><img src="{{ asset('style/images/art/s7.jpg')}}" alt="" /><img src="{{ asset('style/images/art/s7-2.jpg')}}" alt="" /></div>
                                        <a href="{{ asset('style/images/art/s7.jpg')}}" class="hover-icon-first lightbox" data-tip="Enlarge image"><i class="jam jam-qr-code"></i></a>
                                        <a href="#" class="hover-icon-second" data-tip="See details"><i class="jam jam-link"></i></a>
                                    </figure>
                                    <div class="item-content">
                            ...
                            <div class="item item-detailed grid-sizer col-md-6 col-lg-4 branding">
                                <div class="box bg-white shadow p-30">
                                    <figure class="main rounded mb-30">
                                        <div class="item-detailed-image"><img src="{{ asset('style/images/art/s8.jpg')}}" alt="" /><img src="{{ asset('style/images/art/s8-2.jpg')}}" alt="" /></div>
                                        <a href="{{ asset('style/images/art/s8.jpg')}}" class="hover-icon-first lightbox" data-tip="Enlarge image"><i class="jam jam-qr-code"></i></a>
                                        <a href="#" class="hover-icon-second" data-tip="See details"><i class="jam jam-link"></i></a>
                                    </figure>
                                    <div class="item-content">
                            ...
                            <!-- /.item -->
                            <div class="item item-detailed grid-sizer col-md-6 col-lg-4 corporate">
                                <div class="box bg-white shadow p-30">
                                    <figure class="main rounded mb-30">
                                        <div class="item-detailed-image"><img src="{{ asset('style/images/art/s9.jpg')}}" alt="" /><img src="{{ asset('style/images/art/s9-2.jpg')}}" alt="" /></div>
                                        <a href="{{ asset('style/images/art/s9.jpg')}}" class="hover-icon-first lightbox" data-tip="Enlarge image"><i class="jam jam-qr-code"></i></a>
                                        <a href="#" class="hover-icon-second" data-tip="See details"><i class="jam jam-link"></i></a>
                                    </figure>
                                    <div class="item-content">
                                        <h2 class="post-title mb-10"><a href="#">Wine Bag</a></h2>
                                        <div class="meta mb-0">Corporate</div>
                                    </div>
                                    <!-- /.item-content -->
                                </div>
                                <!-- /.box -->
